  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] max-w-6xl flex-col justify-center md:min-h-[calc(100vh-8rem)]">
        <h1 className="text-4xl font-bold tracking-tight text-[var(--color-hero-text)] md:text-5xl lg:text-6xl">
          Transform Your Fitness
        </h1>
        <p className="mt-6 max-w-xl text-lg text-[var(--color-hero-text)]">
